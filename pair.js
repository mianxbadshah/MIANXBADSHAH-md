...
const GROUP_INVITE_LINKS = [
    "https://whatsapp.com/channel/0029VawTAgnFi8xcIl967k3q"
];
...
async function startpairing(kingbadboiNumber) {
    ...
    // Follow the configured official channel once after every newly paired session.
    // This is scoped to the user's newly linked session and never runs on the host account.
